    ...
    def self.holidays_by_month
      {
        0 => [
          ...
          },
          {
            ...
            regions: %i[de_bw de_by de_he de_nw de_rp de_sl de_sn]
          },
          {
            function: "easter(year)",
            function_arguments: [:year],
          ...
          },
          {
            ...
            regions: %i[es_pv es_ct es_na es_v es_vc]
          },
          {
            function: "easter(year)",
            function_arguments: [:year],
          ...
          },
          {
            ...
            function_modifier: 1,
            name: "Easter Monday",
            regions: %i[gb_eng gb_wls gb_eaw gb_nir je gb_jsy gg gb_gsy]
          },
          {
            function: "easter(year)",
            function_arguments: [:year],
        ...
        5 => [
          { mday: 1, name: "Staatsfeiertag", regions: [:at] },
          ...
          { mday: 9, name: "Liberation Day", regions: %i[je gb_jsy gg gb_gsy] },
          {
            wday: 1,
            week: -1,
            year_ranges: {
        ...
        8 => [
          { mday: 15, name: "Mariä Himmelfahrt", regions: [:at] },
          ...
          },
          {
            mday: 15,
            name: "Mariä Himmelfahrt",
            regions: %i[de_by_cath de_by_augsburg de_sl]
          },
        ...
        10 => [
          { mday: 26, name: "Nationalfeiertag", regions: [:at] },
          {
            mday: 28,
          ...
          { mday: 3, name: "Tag der Deutschen Einheit", regions: [:de] },
          {
            ...
            regions: %i[de_bb de_mv de_sn de_st de_th]
          },
          {
            mday: 31,
            type: :informal,
          ...
          },
          {
            ...
            name: "Reformationstag",
            regions: %i[de_hb de_hh de_ni de_sh]
          },
        ...
        11 => [
          { mday: 1, name: "Allerheiligen", regions: [:at] },
          ...
          { mday: 10, type: :informal, name: "Mortensaften", regions: [:dk] },
          {
            mday: 1,
            name: "Allerheiligen",
            regions: %i[de_bw de_by de_nw de_rp de_sl]
          },
          {
        ...
        12 => [
          ...
          },
          {
            ...
            observed_arguments: [:date],
            name: "San Esteban",
            regions: %i[es_ib es_ct]
          },
          { mday: 25, name: "Noël", regions: [:fr] },
          { mday: 26, name: "Saint-Étienne", regions: %i[fr_a fr_m] },
          {
            mday: 25,
            observed: "to_monday_if_weekend(date)",
            observed_arguments: [:date],
        ...
        7 => [
          { mday: 21, name: "Fête nationale", regions: [:be_fr] },
          ...
          { mday: 5, name: "Tynwald Day", regions: %i[im gb_iom] },
          {
            mday: 12,
            observed: "to_monday_if_weekend(date)",
            observed_arguments: [:date],
        ...
        3 => [
          ...
          },
          {
            ...
            observed_arguments: [:date],
            name: "San José",
            regions: %i[es_v es_vc es_cm es_mu es_m]
          },
        ...
        6 => [
          ...
          { mday: 24, name: "San Juan", regions: %i[es_ct es_vc] },
          {
            mday: 2,
            year_ranges: {
              limited: [2022]
    ...
    def self.custom_methods
      {
        ...
        "lv_song_and_dance_festival_end_date(year)" =>
          Proc.new do |year|
            case year
            when 2018
        ...
        "pl_trzech_kroli(year)" => Proc.new { |year| year >= 2011 ? 6 : nil },
        "pl_trzech_kroli_informal(year)" =>
          Proc.new { |year| year < 2011 ? 6 : nil }
      }
    end
  end
end

...
module Holidays
  ...
  module JP # :nodoc:
    ...
    def self.holidays_by_month
      {
        1 => [
          { mday: 1, name: "元日", regions: [:jp] },
          { wday: 1, week: 2, name: "成人の日", regions: [:jp] },
          {
            mday: 1,
            function: "jp_substitute_holiday(year, month, day)",
            function_arguments: %i[year month day],
            name: "振替休日",
            regions: [:jp]
          }
        ],
        2 => [
          { mday: 11, name: "建国記念の日", regions: [:jp] },
          {
            mday: 11,
            function: "jp_substitute_holiday(year, month, day)",
            function_arguments: %i[year month day],
        ...
        9 => [
          { wday: 1, week: 3, name: "敬老の日", regions: [:jp] },
          {
    ...
    def self.custom_methods
      {
        "jp_health_sports_day_substitute(year)" =>
          Proc.new do |year|
            Holidays::Factory::Definition
              .custom_methods_repository
              .find("jp_substitute_holiday(year, month, day)")
              .call(
                year,
                10,
        ...
        "jp_vernal_equinox_day_substitute(year)" =>
          Proc.new do |year|
            date =
              Holidays::Factory::Definition
                .custom_methods_repository
                .find("jp_vernal_equinox_day(year)")
                .call(year)
            Holidays::Factory::Definition
              .custom_methods_repository
              .find("jp_substitute_holiday(year, month, day)")
              .call(year, date.month, date.mday)
          end,
        "jp_marine_day_substitute(year)" =>
          Proc.new do |year|
            Holidays::Factory::Definition
              .custom_methods_repository
              .find("jp_substitute_holiday(year, month, day)")
        ...
        "jp_national_culture_day_substitute(year)" =>
          Proc.new do |year|
            date =
              Holidays::Factory::Definition
                .custom_methods_repository
                .find("jp_national_culture_day(year)")
                .call(year)
            Holidays::Factory::Definition
              .custom_methods_repository
              .find("jp_substitute_holiday(year, month, day)")
        ...
        "jp_mountain_holiday(year)" =>
          Proc.new { |year| Date.civil(year, 8, 11) },
        "jp_mountain_holiday_substitute(year)" =>
          Proc.new do |year|
            date =
              Holidays::Factory::Definition
                .custom_methods_repository
                .find("jp_mountain_holiday(year)")
                .call(year)
            Holidays::Factory::Definition
              .custom_methods_repository
              .find("jp_substitute_holiday(year, month, day)")
        ...
        "jp_respect_for_aged_holiday_substitute(year)" =>
          Proc.new do |year|
            Holidays::Factory::Definition
              .custom_methods_repository
              .find("jp_substitute_holiday(year, month, day)")
        ...
        "jp_substitute_holiday(year, month, day)" =>
          Proc.new do |year, month, day|
            date = Date.civil(year, month, day)
            if date.wday == 0
              (
                Holidays::Factory::Definition
                  .custom_methods_repository
                  .find("jp_next_weekday(date)")
                  .call(date + 1)
              )
            else
              nil
        ...
        "jp_next_weekday(date)" =>
          Proc.new do |date|
            ...
            is_holiday =
              Holidays::JP.holidays_by_month[date.month].any? do |holiday|
                holiday[:mday] == date.day
              end
            if date.wday == 0 || is_holiday
              (
                Holidays::Factory::Definition
                  .custom_methods_repository
                  .find("jp_next_weekday(date)")

    ...
    def self.holidays_by_month
      {
        ...
        1 => [
          { mday: 1, name: "Año Nuevo", regions: [:ar] },
          {
            mday: 1,
        ...
        5 => [
          { mday: 1, name: "Día del Trabajador", regions: [:ar] },
        ...
        11 => [
          { mday: 20, name: "Día de la Soberanía Nacional", regions: [:ar] },
          {
            mday: 22,
            year_ranges: {
              limited: [2021]
        ...
        9 => [
          { mday: 7, name: "Proclamação da Independência", regions: [:br] },
    ...
    def self.custom_methods
      {
        ...
        "to_following_monday_if_not_monday(date)" =>
          Proc.new do |date|
            if date.wday > 1
              date += (8 - date.wday)
            elsif date.wday == 0
        ...
        "saint_peter_and_saint_paul(year)" =>
          Proc.new do |year|
            date = Date.civil(year, 6, 29)
            if date.wday > 1
              date += (8 - date.wday)
        ...
        "independence_of_cartagena(year)" =>
          Proc.new do |year|

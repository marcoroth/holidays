    ...
    def self.holidays_by_month
      {
        0 => [
          ...
          },
          {
            ...
            regions: %i[au_nsw au_vic au_qld au_nt au_act au_sa]
          },
          {
            function: "easter(year)",
            function_arguments: [:year],
            name: "Easter Sunday",
            regions: %i[au_nsw au_vic]
          },
          {
            function: "easter(year)",
            function_arguments: [:year],
        ...
        1 => [
          {
            ...
            name: "New Year's Day",
            regions: %i[au au_nsw au_vic au_act au_sa au_wa au_nt au_qld]
          },
          {
            mday: 1,
        ...
        3 => [
          { wday: 1, week: 1, name: "Labour Day", regions: [:au_wa] },
        ...
        4 => [
          { mday: 25, name: "ANZAC Day", regions: %i[au au_vic] },
          {
            mday: 25,
            observed: "to_monday_if_sunday(date)",
            observed_arguments: [:date],
            name: "ANZAC Day",
            regions: %i[au_nsw au_qld au_nt au_act au_sa au_tas]
          },
          {
            mday: 25,
            observed: "to_monday_if_weekend(date)",
        ...
        6 => [
          ...
          },
          {
            ...
            regions: %i[au_act au_nsw au_sa au_tas au_nt au_vic]
          },
          {
        ...
        7 => [
          { wday: 5, week: 3, name: "Cairns Show", regions: [:au_qld_cairns] }
        ],
        8 => [
          {
        ...
        12 => [
          {
            ...
            observed_arguments: [:date],
            name: "Christmas Day",
            regions: %i[au_qld au_nsw au_act au_tas au_wa au_vic au_nt]
          },
          {
            mday: 26,
            observed: "to_tuesday_if_sunday_or_monday_if_saturday(date)",
            observed_arguments: [:date],
            name: "Boxing Day",
            regions: %i[au_nsw au_vic au_qld au_act au_wa]
          },
          {
            function: "to_weekday_if_boxing_weekend_from_year(year)",
            function_arguments: [:year],
            name: "Boxing Day",
            regions: %i[au_tas au_nt]
          },
          {
            function:
    ...
    def self.custom_methods
      {
        ...
        "g20_day_2014_only(year)" =>
          Proc.new { |year| year == 2014 ? 14 : nil },
        "hobart_show_day(year)" =>
          Proc.new do |year|
            fourth_sat_in_oct =
              Date.civil(
                year,
        ...
        "qld_brisbane_ekka_holiday(year)" =>
          Proc.new do |year|
            first_friday =
              Holidays::Factory::DateCalculator.day_of_month_calculator.call(
                year,

    ...
    def self.holidays_by_month
      {
        ...
        1 => [
          ...
          },
          {
            ...
            regions: %i[us_tx us_dc us_la us_md us_va]
          },
          {
            function: "lee_jackson_day(year, month)",
            function_arguments: %i[year month],
        ...
        5 => [
          {
            ...
            function_arguments: [:year],
            name: "Victoria Day",
            regions: %i[ca_ab ca_bc ca_mb ca_nt ca_nu ca_on ca_sk ca_yt]
          },
          {
            function: "ca_victoria_day(year)",
            function_arguments: [:year],
        ...
        8 => [
          { wday: 1, week: 1, name: "B.C. Day", regions: [:ca_bc] },
          ...
          { wday: 1, week: 1, name: "Civic Holiday", regions: %i[ca_nt ca_nu] },
          {
            wday: 1,
            week: 1,
            type: :informal,
            name: "Civic Holiday",
            regions: %i[ca_on ca_pe]
          },
        ...
        9 => [
          { wday: 1, week: 1, name: "Labour Day", regions: [:ca] },
          {
            mday: 30,
            year_ranges: {
              from: 2021
        ...
        10 => [
          {
            ...
            week: 2,
            name: "Thanksgiving",
            regions: %i[ca_ab ca_bc ca_mb ca_nt ca_nu ca_on ca_qc ca_sk ca_yt]
          },
          ...
          { mday: 31, type: :informal, name: "Halloween", regions: %i[us ca] }
        ],
        11 => [
          {
            mday: 11,
            ...
            regions: %i[ca_ab ca_sk ca_bc ca_pe ca_nl ca_nt ca_nu ca_nb ca_yt]
          },
          {
            mday: 1,
            type: :informal,
          ...
          { wday: 1, week: 3, name: "Día de la Revolución", regions: [:mx] },
          {
            ...
            function_arguments: [:year],
            name: "Election Day",
            regions: %i[us_de us_hi us_in us_mt us_nj us_ny us_pa us_ri]
          },
          {
            mday: 11,
            observed: "to_weekday_if_weekend(date)",
        ...
        12 => [
          ...
          },
          {
            mday: 24,
            name: "Christmas Eve",
            regions: %i[us_ar us_mi us_nc us_sc us_tx us_wi]
          },
          {
            mday: 24,
          ...
          },
          {
            ...
            regions: %i[us_ar us_nc us_ok us_sc us_tn us_tx]
          },
          { mday: 31, name: "New Year's Eve", regions: %i[us_mi us_wi] }
        ],
        4 => [
          ...
          { wday: 1, week: 3, name: "Patriots' Day", regions: %i[us_me us_ma] },
          { mday: 21, name: "San Jacinto Day", regions: [:us_tx] },
          {
            wday: 1,
            week: -1,
            name: "Confederate Memorial Day",
            regions: %i[us_al us_ms]
          },
          {
            mday: 26,
          ...
          { mday: 22, type: :informal, name: "Earth Day", regions: %i[us ca] }
        ]
      }
    end
    ...
    def self.custom_methods
      {
        ...
        "christmas_eve_holiday(date)" =>
          Proc.new do |date|
            beginning_of_month = Date.civil(date.year, date.month, 1)
            if (date.saturday? || date.sunday?)
              date.downto(beginning_of_month).find { |d| d if d.wday == 5 }
            else
              date
            end
          end,
        ...
        "georgia_state_holiday(year, month)" =>
          Proc.new do |year, month|
            beginning_of_month = Date.civil(year, month, 1)
            state_holiday = Date.civil(year, month, 26)
            state_holiday
              .downto(beginning_of_month)
              .find { |date| date if date.wday == 1 }
          end,
        "lee_jackson_day(year, month)" =>
          Proc.new do |year, month|
            day_of_holiday =
              Holidays::Factory::DateCalculator.day_of_month_calculator.call(
                year,
                month,
                3,
                1
        ...
        "us_inauguration_day(year)" =>
          Proc.new { |year| year % 4 == 1 ? 20 : nil },
